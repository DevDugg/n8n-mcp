...
<p>{{ $json.content }}</p>
  ...
  "n8n-nodes-base.ldap": {
    ...
    displayName: "LDAP",
    description: "Interact with LDAP directory services for user authentication and directory queries",
    category: "core",
    typeVersion: 1,
    inputs: ["main"],
    outputs: ["main"],
    parameters: [
      {
        ...
        description: "Operation to perform",
        options: [
          { name: "Compare", value: "compare", description: "Compare attribute value" },
          { name: "Create", value: "create", description: "Create a new entry" },
          { name: "Delete", value: "delete", description: "Delete an entry" },
          { name: "Rename", value: "rename", description: "Rename an entry" },
          { name: "Search", value: "search", description: "Search for entries" },
      ...
      },
      {
        ...
        required: true,
        default: "",
        description: "Base Distinguished Name for the operation",
    ...
    credentials: [
      { name: "ldap", required: true, description: "LDAP server credentials" },
    ],
    examples: [
      {
        name: "Search Users",
        description: "Search for all users in a directory",
        parameters: {
          operation: "search",
    ...
    documentationUrl: "https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.ldap/",
  },
    ...
    parameters: [
      {
        ...
        description: "Operation to perform",
        options: [
          { name: "Generate", value: "generate", description: "Generate a TOTP code" },
          { name: "Verify", value: "verify", description: "Verify a TOTP code" },
        ],
      },
      {
        name: "secret",
      ...
      },
      {
        ...
        required: true,
        default: "",
        description: "TOTP token to verify",
      ...
      },
      {
        ...
        required: false,
        default: {},
        description: "Additional options: algorithm, digits, period",
      },
    ],
    examples: [
      {
        name: "Generate TOTP",
        description: "Generate a 6-digit TOTP code",
        parameters: {
          operation: "generate",
          secret: "={{ $json.totpSecret }}",
        },
      },
    ],
    documentationUrl: "https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.totp/",
  },

  "n8n-nodes-base.executionData": {
    type: "n8n-nodes-base.executionData",
    displayName: "Execution Data",
    description: "Access and save execution metadata for cross-execution data persistence",
    category: "core",
    typeVersion: 1,
    inputs: ["main"],
    outputs: ["main"],
    parameters: [
      {
        ...
        description: "Operation to perform",
        options: [
          { name: "Save", value: "save", description: "Save data to execution" },
          { name: "Load", value: "load", description: "Load data from execution" },
        ],
      },
      {
        name: "dataToSave",
    ...
    examples: [
      {
        ...
        parameters: {
          operation: "save",
          dataToSave: "={{ { lastRun: $now, count: $json.count } }}",
        },
      },
    ],
    documentationUrl: "https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executiondata/",
  },

  "n8n-nodes-base.debugHelper": {
    type: "n8n-nodes-base.debugHelper",
    displayName: "Debug Helper",
    description: "Debug workflow execution with detailed logging and data inspection",
    category: "core",
    typeVersion: 1,
    inputs: ["main"],
    outputs: ["main"],
    parameters: [
      {
        ...
        options: [
          { name: "Do Nothing", value: "doNothing", description: "Pass through without changes" },
          { name: "Throw Error", value: "throwError", description: "Throw an error for testing" },
          { name: "Random Data", value: "randomData", description: "Generate random test data" },
        ],
      },
      {
        name: "errorMessage",
    ...
    examples: [
      {
        ...
        description: "Generate random test data for workflow testing",
        parameters: {
          category: "randomData",
          randomDataCount: 5,
        },
  ...
  "n8n-nodes-base.n8n": {
    ...
    displayName: "n8n",
    description: "Interact with the n8n API to manage workflows, executions, and credentials",
    category: "core",
    typeVersion: 1,
    inputs: ["main"],
    outputs: ["main"],
    parameters: [
      {
        ...
        options: [
          { name: "Audit", value: "audit", description: "Audit logs" },
          { name: "Credential", value: "credential", description: "Credentials" },
          { name: "Execution", value: "execution", description: "Executions" },
          { name: "Workflow", value: "workflow", description: "Workflows" },
        ],
      },
      {
        name: "operation",
        ...
        description: "Operation to perform",
        options: [
          { name: "Activate", value: "activate", description: "Activate a workflow" },
          { name: "Create", value: "create", description: "Create a workflow" },
          { name: "Deactivate", value: "deactivate", description: "Deactivate a workflow" },
          { name: "Delete", value: "delete", description: "Delete a workflow" },
          { name: "Get", value: "get", description: "Get a workflow" },
          { name: "Get All", value: "getAll", description: "Get all workflows" },
          { name: "Update", value: "update", description: "Update a workflow" },
        ],
        displayOptions: { show: { resource: ["workflow"] } },
      },
    ],
    credentials: [
      { name: "n8nApi", required: true, description: "n8n API credentials" },
    ],
    examples: [
      {
        name: "List Workflows",
